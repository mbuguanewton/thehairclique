                ...
                <div className="relative aspect-[16/10]">
                  {feature.image && (
                    <AmbientImage
                      ...
                      containerClassName="rounded-app bg-card transition-all duration-500 shadow-sm group-hover:shadow-lg"
                      imageClassName="object-contain transition-transform duration-700 group-hover:scale-105"
                    />
                  )}

                  <div className="absolute top-4 right-4 w-8 h-8 rounded-full bg-white/10 border border-white/20 flex items-center justify-center backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20 pointer-events-none">
